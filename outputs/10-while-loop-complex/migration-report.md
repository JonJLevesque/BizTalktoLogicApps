# BizTalk Migration Report: WhileLoopComplex

Generated: 2026-02-28 | AI mode: proxy | Runtime: 74.2s
...
| Property | Value |
|----------|-------|
| Application | WhileLoopComplex |
| Complexity | highly-complex (123/100) |
| Orchestrations | 1 |
| Maps | 0 |
| Pipelines | 0 |
| Bindings | 0 |
...
Detected **4** enterprise integration pattern(s): 2 migrate automatically, 2 require review, 0 require redesign.
...
Output directory: `outputs/10-while-loop-complex`

**Workflows:**
- `Orchestration_1/workflow.json`
...
2. **Deploy via VS Code:**
   ```
   Right-click `outputs/10-while-loop-complex` → Deploy to Logic App...
   ```
