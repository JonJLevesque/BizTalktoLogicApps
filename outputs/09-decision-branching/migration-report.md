# BizTalk Migration Report: DecisionBranching

Generated: 2026-02-28 | AI mode: proxy | Runtime: 31.1s
...
| Property | Value |
|----------|-------|
| Application | DecisionBranching |
| Complexity | moderate (20/100) |
| Orchestrations | 1 |
| Maps | 0 |
| Pipelines | 0 |
| Bindings | 0 |
...
Detected **3** enterprise integration pattern(s): 2 migrate automatically, 1 require review, 0 require redesign.
...
Output directory: `outputs/09-decision-branching`

**Workflows:**
- `BulkUpdateAccountsRespCoordinator/workflow.json`
...
2. **Deploy via VS Code:**
   ```
   Right-click `outputs/09-decision-branching` → Deploy to Logic App...
   ```
